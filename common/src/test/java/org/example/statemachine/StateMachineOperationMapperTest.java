...
class StateMachineOperationMapperTest {
    ...
    void roundTrip_transfer_operation() {
        ...
        // toProto
        org.example.MessageServiceOuterClass.Operation proto = StateMachineOperationMapper.toProto(input);
        ...
        // fromProto
        StateMachineOperation roundTripped = StateMachineOperationMapper.fromProto(proto);
    ...
    void fromProto_throws_on_unset_oneof() {
        ...
        IllegalArgumentException ex = assertThrows(IllegalArgumentException.class, () -> StateMachineOperationMapper.fromProto(unset));
