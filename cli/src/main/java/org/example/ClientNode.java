...
public class ClientNode extends Node {
     ...
     */
    private MessageServiceOuterClass.ClientRequest generateClientRequest(MessageServiceOuterClass.Transfer transaction) {
    ...
    public void processTransaction(MessageServiceOuterClass.Transfer transaction) {
